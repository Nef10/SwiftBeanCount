...
extension RogersBankMappingError: LocalizedError {
    public var errorDescription: String? {
        switch self {
        case let .missingAccount(lastFour):
            return "The account with the last four digits \(lastFour) was not found in your ledger. Please make sure you add \(MetaDataKeys.account): \"\(lastFour)\" to it."
