...
struct LedgerLookupTests {
    ...
    @Test
    func ledgerAccountCommoditySymbol() throws {
        let ledger = Ledger()
    ...
    @Test
    func ledgerAccountNameOf() throws {
        let ledger = Ledger()
        var ledgerLookup = LedgerLookup(ledger)
    ...
    @Test
    func ledgerAccountNameFor() throws { // swiftlint:disable:this function_body_length
        let ledger = Ledger()
        var ledgerLookup = LedgerLookup(ledger)
    ...
    @Test
    func doesTransactionExistInLedger() {
        let ledger = Ledger()
        var ledgerLookup = LedgerLookup(ledger)
    ...
    @Test
    func doesPriceExistInLedger() throws {
        let ledger = Ledger()
        var ledgerLookup = LedgerLookup(ledger)
    ...
    @Test
    func doesBalanceExistInLedger() throws {
        let ledger = Ledger()
        var ledgerLookup = LedgerLookup(ledger)
    ...
    @Test
    func commoditySymbolForAssetSymbol() throws {
        let ledger = Ledger()
        var ledgerLookup = LedgerLookup(ledger)
