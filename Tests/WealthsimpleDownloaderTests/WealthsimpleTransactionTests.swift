...
final class WealthsimpleTransactionTests: DownloaderTestCase { // swiftlint:disable:this type_body_length
   ...
   private func setupGraphQLMockForSuccess(
       activityResponses: [[String: Any]], fxResponses: [[String: Any]], expectation: DispatchSemaphore, file _: StaticString = #file, line _: UInt = #line
   ) throws {
       var callCount = 0
   ...
   private func testGraphQLFailure(expectation: DispatchSemaphore, expectedError: TransactionError, file _: StaticString = #file, line _: UInt = #line) throws {
...
// see https://github.com/swiftlang/swift-corelibs-foundation/issues/3199
   ...
   @Test
   func graphQLPaginationSuccess() throws { // swiftlint:disable:this function_body_length
       let expectation = DispatchSemaphore(value: 0)
       let mockExpectation = DispatchSemaphore(value: 0)
   ...
   @Test
   func invalidGraphQLURLFx() throws {
       let expectation = DispatchSemaphore(value: 0)
       let mockExpectation = DispatchSemaphore(value: 0)
       var callCount = 0
       MockURLProtocol.graphQLRequestHandler = { _, request in
