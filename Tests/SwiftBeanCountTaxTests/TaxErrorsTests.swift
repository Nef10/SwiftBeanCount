...
@Suite
struct TaxErrorsTests { // swiftlint:disable line_length

   @Test
   func entriesWithAndWithoutSymbolErrorDescription() {
   ...
   @Test
   func noTaxSlipConfiguredErrorDescription() {
   ...
   @Test
   func noCurrencyDefinedErrorDescription() {
   ...
   @Test
   func splitAccountDifferentSymbols() {
