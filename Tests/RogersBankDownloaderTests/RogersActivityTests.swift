...
struct RogersActivityTests {
    ...
    func testRogersActivity() throws {
        ...
        #expect(activity.activityType == ActivityType.authorization)
        #expect(activity.activityStatus == ActivityStatus.pending)
        #expect(activity.activityCategory == ActivityCategory.tokenAuthRequest)
